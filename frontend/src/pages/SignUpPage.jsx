...
const SignUpPage = () => {
  ...
  return (
    ...
    <div className="min-h-screen grid lg:grid-cols-[1fr_auto_1fr]">

      {/* Left Side */}
      <div className="flex items-center justify-center">
        <div className="flex flex-col items-center gap-2">
          <div className="size-32 rounded-xl bg-primary/10 flex items-center justify-center">
            <MessageSquare className="size-16 text-primary" />
          </div>

          <h1 className="text-6xl font-bold">WEG</h1>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center">
        <div
          className=" h-96 w-px bg-primary scale-x-150 shadow-[0_0_25px_hsl(var(--p))] "
        />
      </div>
